...
export class GenerateTable1688453601525 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`card_tag_map\` (\`id\` int NOT NULL AUTO_INCREMENT, \`indicator\` decimal NULL, \`mind_card_id\` int NOT NULL, \`mind_tag_id\` int NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
